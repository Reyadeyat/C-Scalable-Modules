...
readelf -s ./c-lib/lib/libc-lib-module-a.0.0.0.so
objdump -T ./c-lib/lib/libc-lib-module-a.0.0.0.so
...
readelf -s ./c-lib/lib/libc-lib-module-a.0.0.1.so
objdump -T ./c-lib/lib/libc-lib-module-a.0.0.1.so
